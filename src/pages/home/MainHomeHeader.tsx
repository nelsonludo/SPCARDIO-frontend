const MainHomeHeader = () => {
  return (
    <div className="bg-emerald-300 min-h-screen flex flex-col justify-center lg:px-32 px-5 text-white bg-[url('/images/background.jpg')] bg-no-repeat bg-cover opacity-90 bg-blend-darken">
